...
) : BaseZone(objects, plugin, graphs, pathfinder, logger, ZoneId.NorthHorn)
{
        ...
        new()
        {
            ...
            // In a Pot of Bother (South) — Fate 2073
            {
                2073, [
                    ...
                    new(new(-172.6f, 6.0019975f, 103.2f), 99),
                ]
            }
        };
    ...
    [
        // Levels estimated from nearest GetTreasureData() coffer (2D, ~150y; else 20).
        new(1, new(-857.4f, 71.45287f, 379.6f), 34),
        new(2, new(7.60699f, 4.3169565f, -35.67316f), 39),
        new(3, new(287.2872f, 142.99992f, -366.9024f), 26),
        new(4, new(-608.8f, 59.286507f, 373.9f), 34),
        new(5, new(-254f, 54.388798f, -739f), 27),
        new(6, new(-560.9f, 50.74249f, -447f), 37),
        new(7, new(-500f, 48.000004f, -867.6f), 38),
        new(8, new(226f, 90.400055f, 904f), 30),
        new(9, new(-258.7481f, 3.588304f, 53.59217f), 40),
        new(10, new(-604f, 160.05638f, 939.1f), 41),
        new(11, new(756.858f, 68.92707f, -79.33746f), 24),
        new(12, new(-814.6948f, 5.6813054f, -561.0853f), 45),
        new(13, new(-129.7795f, 8.029996f, -171.18f), 39),
        new(14, new(-847.9f, 114f, 196.6f), 34),
        new(15, new(-808f, 6.3495464f, -879f), 46),
        new(16, new(960f, 97.05797f, -879f), 44),
        new(17, new(625.8f, 61.06923f, -846.3f), 43),
        new(18, new(-956.1f, 157.8f, 720.2f), 42),
        new(19, new(-581f, 160f, 791f), 41),
        new(20, new(108f, 22.332209f, -556f), 25),
        new(21, new(-35f, 72.89336f, -860f), 27),
        new(22, new(882.1526f, 53.999996f, 115.9092f), 20),
        new(23, new(923f, 80.26997f, -277f), 28),
        new(24, new(853.9f, 70.20017f, -343.3f), 28),
        new(25, new(-124f, 76.75548f, 777f), 30),
    ];
