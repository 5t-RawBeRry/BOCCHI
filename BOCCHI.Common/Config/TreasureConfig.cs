...
public class TreasureConfig : IAutoConfig
{
    ...
    [Checkbox(Order = 11, Section = "treasure_hunt")]
    ...
    /// </summary>
    [IntRange(0, 100, Order = 12, Section = "treasure_hunt")]
    ...
    /// </summary>
    [FloatRange(10f, 60f, Order = 14, Section = "treasure_hunt")]
    ...
    [Checkbox(Order = 15, Section = "treasure_hunt")]
