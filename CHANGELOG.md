...
### Treasure Hunt
- Max coffer level applies to shared-map pads too (level 46+ areas no longer slip through when capped at 40)
...
### Carrot Hunt
- Pads on a higher shelf use Return / aethernet instead of a direct cliff walk
...
- Phantom Chemist / WHM raises enabled in BOCCHI AR presets
- Healer AI: Swiftcast raises, heal, esuna, stay near party, OOC tank predictive heals — update presets if auto-update is off
