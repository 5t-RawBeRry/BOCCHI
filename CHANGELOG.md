...
- **Shared maps (default on):** Config → Treasure Hunter → Share maps with the community. Downloads shared carrot/coffer pads and pot timers; anonymously uploads what you see. Turn off for built-in maps and local pot timing only.
