...
- Pot chest hunting opens the coffer it just found. Finding the chest is what removes Cache Me If You Can, and BOCCHI treated losing that buff as "farm over" — so it walked off to the next FATE the instant it succeeded, without dismounting or opening. It now dismounts and opens the revealed coffer first, and stays around long enough to pick up a reroll if one is offered.
