...
### New
- Illegal Mode combat can use Wrath Combo or Rotation Solver Reborn together with BOCCHI AI, or a full BossMod / BossMod Reborn autorotation. Pick one under General → Combat. It turns off while traveling.
...
- Carrot Hunt no longer mount-spams on tall climbs, and skips a pad if it stays stuck after a few recoveries. North Horn now clears the center first, then northwest, then northeast.
